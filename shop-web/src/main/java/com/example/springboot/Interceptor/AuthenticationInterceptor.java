...
import com.yelang.shop.base.annotation.PassToken;
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object object) throws Exception {
        ...
        if (method.isAnnotationPresent(UserLoginToken.class)) {
            ...
            if (userLoginToken.required()) {
                ...
                String loginAccount;
                try {
                    loginAccount = JWT.decode(token).getAudience().get(0);
                ...
                userInfoExample.createCriteria().andUserIDEqualTo(loginAccount);
                List<UserInfo> users = userInfoMapper.selectByExample(userInfoExample);
                if(users!=null && users.size()>0){
                    pwd = users.get(0).getUserPwd();
                }else{
                    ...
                    if(businessUsers!=null && businessUsers.size()>0){
                        pwd = businessUsers.get(0).getLoginPassword();
                    }else{
