...
import com.example.springboot.sendMessage.utils.HttpDeleteUtil;
import com.example.springboot.sendMessage.utils.RequestEncoder;
...
/**
 * @description: 这个类实现了ISender，包含了在发送之前处理发生的事件的常用方法 创建了一个签名并构建请求数据
 * @author: SunZH
 * @time: 2020/3/19 0019 上午 11:33
 */
