 ...
 * @description:
 * @author: Andy
 * @time: 2020/1/14 0014 上午 10:23
 */
public class DateUtil {

    private static String orderFormat = "yyyyMMddHHmmss";
    /**
     * 时间戳转换成日期格式字符串
     ...
     * @return
     */
    public static String timeStampToOrderFormat(Long seconds) {
        SimpleDateFormat sdf = new SimpleDateFormat(orderFormat);
